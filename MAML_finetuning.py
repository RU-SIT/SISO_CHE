...
if __name__ == '__main__':
    ...
    argparser.add_argument('--root', type=str, default="Sionna_datasets/ps2_p612/speed5/SISO-UMi")
    argparser.add_argument('--device', type=str, default='cuda:0')
    argparser.add_argument('--save_init', type=str, default="SISO_UMi_init")
    argparser.add_argument('--step', type=int, default=4000)
    argparser.add_argument('--epoch', type=int, default=4000)
    ...
    argparser.add_argument('--n_way', type=int, default=2)

...
class TensorOfflineDataset:
    ...
    def __init__(
        self, path: str, seed=int, train_split: float = 0.9, main_train_split: float = 0.8, input_type: str = "raw"
    ) -> None:

        self.main_path = path
        self.seed = seed
        self.train_split = train_split
        self.main_train_split = main_train_split
    ...
    def split(self):
        ...
        train_indices, self.test_indices = make_split(
            len(self.inputs), train_fraction=self.main_train_split
        )

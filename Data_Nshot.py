"""
This script should be used as dataclass of the MAML model for preparing data to serve as Nshot lerner.
Also this script, is called after converting to pytorch Dataset.
"""
